...
export const NotificationMessages = {
  WARN: {
    MISSING_API_KEY: 'Thiếu RESEND_API_KEY. Hệ thống sẽ chạy ở chế độ mô phỏng (dry-run).',
  },
  LOG: {
    ...
    SENT_SUCCESS_DEV: 'Email OTP đã được gửi thành công đến {{to}}. Phản hồi: {{response}}',
